  ...
  return (
    <div className="h-full overflow-y-scroll p-6 flex  items-start flex-wrap gap-4 text-slate-700">
      ...
      >
        ...
        <button
          disabled={loading}
          className="w-full mt-6 flex items-center justify-center gap-2 px-4 py-2 text-sm bg-gradient-to-r from-[#C341F6] to-[#8E37EB] text-white rounded-lg cursor-pointer"
        >
          {loading ? (
